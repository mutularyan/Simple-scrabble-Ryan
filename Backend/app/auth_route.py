...
def login():
    ...
    if not user.game:
        ...
        # Create a new Scrabble board (15x15) and initialize it with special tiles
        ...
        # Initialize tile bag and player racks
        letter_no = {
        ...
        # Print the initial state for debugging purposes
        ...
        # Add the new game to the session and commit to the database
        db.session.add(game)
        db.session.commit()
